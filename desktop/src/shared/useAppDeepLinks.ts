import { useBapProofDeepLinks } from "@/features/bap/hooks";
 ...
 * `buzz://message`, the `buzz://repo|project|pr|issue` share links, and the
 * `buzz://bap/proof` return trip from the BAP approval page.
 *
